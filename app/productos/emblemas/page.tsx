...
const emblemasImages = [
  ...
  { id: 'emblema-2', src: '2.jpg', alt: 'Emblema 2' },
  { id: 'emblema-3', src: '3.jpg', alt: 'Emblema 3' },
  { id: 'emblema-4', src: '4.jpg', alt: 'Emblema 4' },
  { id: 'emblema-5', src: '5.jpg', alt: 'Emblema 5' },
  { id: 'emblema-6', src: '6.jpg', alt: 'Emblema 6' },
  { id: 'emblema-7', src: '7.jpg', alt: 'Emblema 7' },
  { id: 'emblema-8', src: '8.jpg', alt: 'Emblema 8' }
];
...
const EmblemasPage = () => {
  ...
  const handleImageClick = (id: string) => {
    setSelected(id);
    router.push(`/productos/emblemas?item=${id}`);
  };

  const closeOverlay = () => {
    setSelected(null);
    router.push("/productos/emblemas");
  };

  const shareUrl =
    typeof window !== "undefined"
      ? `${window.location.origin}/productos/emblemas?item=${selected}`
      : "";
      ...
      <div className="w-full p-2 pb-4 sm:px-5 lg:px-7 flex justify-start">
        ...
        <div className="">
          <Button variant="secondary">
            <a href="https://photos.app.goo.gl/u6rhhym2NaSwJkFr7" target="_blank" rel="noopener noreferrer" className="flex gap-2 cursor-pointer text-sm">
