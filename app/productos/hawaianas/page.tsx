...
const hawaianasImages = [
    ...
    { id: 'hawaiana-2', src: '2.jpg', alt: 'Hawaiana 2' },
    { id: 'hawaiana-3', src: '3.jpg', alt: 'Hawaiana 3' },
    { id: 'hawaiana-4', src: '4.jpg', alt: 'Hawaiana 4' },
    { id: 'hawaiana-5', src: '5.jpg', alt: 'Hawaiana 5' },
    { id: 'hawaiana-6', src: '6.jpg', alt: 'Hawaiana 6' },
    { id: 'hawaiana-7', src: '7.jpg', alt: 'Hawaiana 7' },
    { id: 'hawaiana-8', src: '8.jpg', alt: 'Hawaiana 8' }
  ];
...
const HawaianasPage = () => {
  ...
  const handleImageClick = (id: string) => {
    setSelected(id);
    router.push(`/productos/hawaianas?item=${id}`);
  };

  const closeOverlay = () => {
    setSelected(null);
    router.push("/productos/hawaianas");
  };

  const shareUrl =
    typeof window !== "undefined"
      ? `${window.location.origin}/productos/hawaianas?item=${selected}`
      : "";
